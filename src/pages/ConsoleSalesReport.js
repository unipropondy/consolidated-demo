...
const API_BASE_URL = process.env.REACT_APP_BASE_URL || "https://consolidated-demo-production.up.railway.app";
const ORG_URL = `${API_BASE_URL}/api/organization`;
const REPORT_URL = `${API_BASE_URL}/api/consolesales`;
